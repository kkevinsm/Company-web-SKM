                ...
                <div class="bg-gray-50 p-8 md:p-12">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                        <div class="md:col-span-2 space-y-4">
                            ...
                            <a href="https://maps.app.goo.gl/your-link" target="_blank" class="inline-flex items-center justify-center gap-2 h-12 py-3 px-8 border-2 border-black rounded-full text-black text-base font-bold hover:bg-[#f96628] hover:border-[#f96628] hover:text-white transition-colors duration-300">
