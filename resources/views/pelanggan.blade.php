...
@section('content')
    ...
    <section class="relative h-screen flex items-center justify-start overflow-hidden">
        ...
        <div class="absolute top-0 left-0 w-full h-full z-0">
            {{-- Anda bisa mengganti ini dengan gambar yang sesuai untuk halaman pelanggan --}}
        ...
        <div class="container mx-auto px-6">
            ...
            @php
                $pelanggan = [
                    ...
                    ['name' => 'PT. Coca-Cola Amatil Indonesia', 'logo' => 'logo-cola.png'],
            ...
            <div class="flex flex-wrap justify-center gap-8">
                ...
                class="flex flex-col items-center justify-center text-center p-4 bg-gray-50 rounded-lg shadow-sm h-48 w-56 transition duration-300 hover:shadow-xl hover:-translate-y-2"
                >
